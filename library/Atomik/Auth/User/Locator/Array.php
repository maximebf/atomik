 ...
 * @subpackage Auth
 */
class Atomik_Auth_User_Locator_Array implements Atomik_Auth_User_Locator_Interface
{
	/** @var array */
	...
	public function addUser($username, $password = '', $roles = array())
	{
		...
		$this->_users[$username] = new Atomik_Auth_User_Array($username, $password, $roles);
	}
