 ...
 * @subpackage Model
 */
abstract class Atomik_Model_Persister
{
     ...
     */
    abstract public function insert(Atomik_Model $model);
     ...
     * @param Atomik_Model $model
     */
    abstract public function update(Atomik_Model $model);
     ...
     * @param Atomik_Model $model
     */
    abstract public function delete(Atomik_Model $model);
}